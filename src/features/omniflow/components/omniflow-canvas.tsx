  ...
  return (
    <TooltipProvider>
      ...
      <div className="flex h-screen bg-gray-50 dark:bg-background">
        {/* Sidebar */}
        <div className="w-80 bg-white dark:bg-card border-r border-gray-200 dark:border-border">
          <div className="p-4 border-b border-gray-200 dark:border-border">
            <div className="flex items-center gap-2">
              <Building2 className="h-6 w-6 text-blue-600 dark:text-blue-400" />
              <h2 className="text-lg font-semibold text-gray-900 dark:text-foreground">OmniFlow</h2>
            </div>
            <p className="text-sm text-gray-600 dark:text-muted-foreground mt-1">Security Workflow Visualization</p>
          </div>
                ...
                {assetTreeNodes.map(node => (
                  <div key={node.id} className="space-y-1">
                    <div
                      className={`flex items-center gap-2 p-2 rounded-lg cursor-pointer transition-colors ${
                        focusedTenant === node.id
                          ...
                          : 'hover:bg-gray-100 dark:hover:bg-gray-700 text-gray-700 dark:text-foreground'
                      }`}
                    ...
                    {node.children?.map(child => (
                      <div
                        key={child.id}
                        className="ml-4 flex items-center gap-2 p-2 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 cursor-pointer transition-colors text-gray-600 dark:text-muted-foreground"
                      >
        ...
        <div className="flex-1 flex flex-col">
          ...
          <div
            ref={containerRef}
            className="flex-1 relative overflow-hidden bg-gray-50 dark:bg-background canvas-container canvas-dots-light dark:canvas-dots-dark select-none"
