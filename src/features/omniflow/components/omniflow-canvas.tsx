    ...
    <TooltipProvider>
      ...
      <div className="flex h-screen bg-gray-50 dark:bg-gray-900">
        ...
        <div className="w-80 bg-white dark:bg-gray-800 border-r border-gray-200 dark:border-gray-700">
          <div className="p-4 border-b border-gray-200 dark:border-gray-700">
            <div className="flex items-center gap-2">
              ...
              <h2 className="text-lg font-semibold text-gray-900 dark:text-gray-100">OmniFlow</h2>
            </div>
            <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">Security Workflow Visualization</p>
          </div>
                ...
                {assetTreeNodes.map(node => (
                  <div key={node.id} className="space-y-1">
                    ...
                    {node.children?.map(child => (
                      <div
                        key={child.id}
                        className="ml-4 flex items-center gap-2 p-2 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 cursor-pointer transition-colors text-gray-600 dark:text-gray-400"
                      >
        ...
        <div className="flex-1 flex flex-col">
          ...
          <div
            ref={containerRef}
            className="flex-1 relative overflow-hidden bg-gray-50 dark:bg-gray-900 canvas-container canvas-dots-light dark:canvas-dots-dark select-none"
          ...
          >
            ...
            >
              ...
              {flowBoxes.map(box => (
                <div
                  key={box.id}
                  className={`flow-box absolute bg-white dark:bg-gray-800 rounded-lg shadow-lg border-2 transition-all duration-300 select-none ${
                    selectedFlow === box.id
